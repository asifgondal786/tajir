...
import { useTerminalDimensions, useTerminalCapabilities, } from "../../context/TerminalInfo.js";
...
function ITerm2Image(props) {
    const [imageOutput, setImageOutput] = useState(undefined);
    ...
    const [actualSizeInCells, setActualSizeInCells] = useState(null);
    ...
    useLayoutEffect(() => {
        ...
        if (!componentPosition)
            return;
        if (stdout.rows - componentPosition.appHeight + componentPosition.row < 0 ||
    ...
    return (React.createElement(Box, { ref: containerRef, flexDirection: "column", flexGrow: 1 }, imageOutput ? (React.createElement(Text, { color: "gray", wrap: "wrap" }, props.alt || "Loading...")) : (React.createElement(Box, { flexDirection: "column", alignItems: "center", justifyContent: "center" },
...
function toITerm2(imageData, options) {
    ...
    const iTerm2Data = "\x1b]1337;File=" +
        `size=${info.size};` +
